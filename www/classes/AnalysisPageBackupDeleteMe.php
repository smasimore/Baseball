...
class AnalysisPage extends Page{
    ...
    private 
        ...
        $gamesData,
        $resultData,
        $overallData = array('games_bet' => 0, 'amount_bet' => 0, 'amount_won' => 0);
    ...
    public function __construct($params) {
        ...
        if (!isset($params[BetParams::MAGIC])) {
            $this->magic = false;
        } 
    ...
    private function fetchData() {
        $magic = $this->magic ? 'magic' : 'nomagic';
        $sim_table = "sim_output_$magic"."_2013";
        ...
        foreach ($sim_data['2013'] as $key => $data) {
    ...
    public function getGraphData($type = 'cash') {
        ...
        return array($graph_x, $graph_y, $hacky_zero);
    }
    ...
    private function getSimInputList() {
        ...
        $magic_checked = $this->magic ? 'checked' : '';
        $magic_checkbox = $this->renderInputTableRow(
            'Magic (DNE)',
            "<input type='checkbox' $magic_checked name = " . BetParams::MAGIC . " />"
        );
    ...
    private function getDynamicBetAmount($pot, $adv, $sim_pct) {
