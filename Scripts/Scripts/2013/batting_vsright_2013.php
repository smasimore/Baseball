...
for ($id = 1; $id < 2500; $id += 30) {
	...
	$target = "http://espn.go.com/mlb/stats/batting/_/split/32/count/".$id."/qualified/false";
	$target_expanded = "http://espn.go.com/mlb/stats/batting/_/split/32/count/".$id."/qualified/false/type/expanded";
	$target_saber = "http://espn.go.com/mlb/stats/batting/_/split/32/count/".$id."/qualified/false/type/sabermetric";
...
foreach ($player_stats as $stats) {
	...
	insert($database, 'batting_vsright_2013', $data);
}
