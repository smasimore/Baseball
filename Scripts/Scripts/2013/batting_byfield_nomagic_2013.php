...
foreach ($stadium_final as $split_name => $stat) {
	$stadium_final[$split_name]['stadium'] = $split_name;
}

$sql_colheads = $stadium_final['colheads'];
foreach ($stadium_final as $stats) {
	...
	insert($database, 'batting_byfield_nomagic_2013', $data);
}
