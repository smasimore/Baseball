...
def runGame(game_data, input_data, game_num):
    ...
    print data['home_i']
    home_results, home_details = stats_game.playGame(home_batting, home_extra_info, ANALYSIS_RUNS)
    away_results, away_details = stats_game.playGame(away_batting, away_extra_info, ANALYSIS_RUNS)
